# PALcares Website — All Content

> **Purpose:** Single reference for reviewing and rewriting website copy.
> Organized in scroll order, top to bottom. Edit freely — this file is not consumed by the build.
>
> **Bold** marks text that renders with visual emphasis (bold/semibold) on the site.
> *Italic* marks text that renders with medium weight or italic styling.

---

## Site Metadata (browser tab, SEO, social sharing)
...
| OG image alt | PALcares - Sustainable Technology Partnerships |
| Twitter title | PALcares \| Technology That Strengthens Relationships |
| Twitter description | Embedded partnerships and open-source tools for Alberta's social sector. |

---

## Loader

Rotating brand words: **teams** / **labs** / **research** / **cares**
...
### Desktop Nav Items
- Our Story
- How We Work (submenu: Teams, Research, Labs)
- Our Approach
- Values
- Partners
...
**Tagline:**
> Technology that **strengthens the relationships** your work depends on
...
## Where We Started (NeedWeNoticed)
...
## Storytelling — Intro Panel

**Heading (h2):** An ecosystem in three parts

**Subtitle:**
Not three separate services—**one approach** where each part strengthens the others.

**Scroll cue:** Scroll

---

## Storytelling — Panel 1: PAL Teams
...
**Quote:**
> What emerges from embedded work carries weight—it's been tested, refined, shaped by the people doing the work. Open licensing means it stays with the community.

---

## Storytelling — Panel 3: PAL Labs
...
## Storytelling — Panel 4: How It Connects

**Heading:** How It Connects

**Description:**
**Each part sustains the others.** Teams does the foundational work—learning your organization, building *processes and tools*. Research generalizes what survives *daily use* and releases it under open license. Labs builds on that foundation to *grow local expertise*.

### Ecosystem Triangle Nodes

**Desktop layout:**

| Node | Description |
|------|-------------|
| Research | Generalizes & shares under **open license** |
| Teams | **Foundational** work & infrastructure |
| Labs | **Extends capacity** locally |

**Intermediate desktop (md breakpoint) — vertical stack:**

| Node | Description |
|------|-------------|
| Research | Generalizes & shares under open license |
| Teams | Foundational work, relationships & infrastructure |
| Labs | Extends capacity, builds on foundation |

**Mobile (<xl) — triangle layout:**

| Node | Description |
|------|-------------|
| Research | Generalizes & shares |
| Teams | Foundational work |
| Labs | Extends capacity |

---

## Our Approach (DeeperContext)
...
### Beat 3 — What Time Makes Possible
...
**Section label:** Partner Voices
**Heading (h2):** Organizations We Work With

### Testimonial 1 — Claire MacDonald
...
**Buttons:** "Read full testimonial" / "Show less"

### Testimonial 2

- **Placeholder** — "Partner testimonial coming soon"
...
| Field | Label | Notes |
|-------|-------|-------|
| First Name | First Name | Required — "First name is required" |
| Last Name | Last Name | Required — "Last name is required" |
| Email | Email | Required — "Valid email required" |
| Organization | Organization (optional) | Optional |
| Message | How can we help? | Required (min 10 chars) — Placeholder: "Tell us about your organization and what you're looking for..." |
...
**Services:** Open tools · Shared resources · Local expertise
...
**Copyright:** PALcares (Perseverance Analytics Ltd.) — with dynamic year

**Footer links:**
- Privacy (links to /privacy-policy)
- Terms (links to /terms-of-use)

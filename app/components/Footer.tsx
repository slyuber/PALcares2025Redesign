            ...
            <nav className="flex flex-col gap-2.5">
              {links.map((link) => (
                <a
                  key={link.name}
                  href={link.href}
                  className="text-sm text-[#5C306C]/55 hover:text-[#5C306C] transition-colors duration-200 w-fit focus:outline-none focus-visible:underline focus-visible:text-[#5C306C]"
                >
                  {link.name}
                </a>
              ))}
          ...
          <div className="space-y-5">
            ...
            {isSubscribed ? (
              ...
              <form onSubmit={handleSubscribe} className="flex gap-2">
                ...
                <button
                  type="submit"
                  className="px-4 py-2.5 rounded-full bg-[#5C306C] text-white text-sm font-medium hover:bg-[#472055] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#5C306C]"
                >
                  Subscribe
                </button>
              </form>

        ...
        >
          ...
          >
            ...
            <ContentPanelMobile
              ...
              title="PAL Teams"
              description={<>PAL Teams embeds a technical team directly within partner organizations for <strong className="font-semibold text-[#5C306C]">multi-year partnerships</strong>&mdash;building the relationships, processes, and infrastructure that let frontline expertise guide technology development.</>}
              ...
              items={[
                <><strong className="font-semibold text-[#5C306C]">Multi-year partnerships</strong> create the time needed to build relationships, processes, and real understanding</>,
                <><strong className="font-semibold text-[#5C306C]">Contracts structured for flexibility,</strong> so roadblocks become problems to solve together, not threats to the project itself</>,
            ...
            <ContentPanelMobile
              ...
              items={[
                <><strong className="font-semibold text-[#5C306C]">Decisions about what to generalize are driven by sector demand,</strong> not internal preference: we identify who needs a solution before deciding whether to build it</>,

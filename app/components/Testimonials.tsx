      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-10 md:gap-12">
          {testimonials.map((testimonial, index) => (
            ...
            >
              {/* Quote Icon Badge */}
              <div className="absolute -top-5 left-8 w-10 h-10 rounded-xl bg-gradient-to-br from-[#FF9966] to-[#FF8552] shadow-lg shadow-[#FF9966]/30 flex items-center justify-center">
